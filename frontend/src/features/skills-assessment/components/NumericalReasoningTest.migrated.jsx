...
const NumericalReasoningTest = ({ onBackToDashboard, testId = null }) => {
  // State management
    ...
    return (
      <div className="bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center min-h-screen">
        ...
        >
          ...
          <p className="text-gray-600">Preparing your numerical reasoning assessment...</p>
        </motion.div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <FaCalculator className="text-blue-600 text-xl mr-3" />
            ...
            <div className="mb-6">
              <div className="flex items-center mb-4">
                ...
                <span className="text-sm text-gray-500">
                  {currentQ.difficulty_level || 'Medium'} Difficulty
                </span>
              </div>
              ...
              {currentQ.options.map((option, optionIndex) => (
                <label
                  ...
                  className={`flex items-center p-4 rounded-lg border cursor-pointer transition-colors ${
                    answers[currentQ.id] === String.fromCharCode(65 + optionIndex)
                ...
                >
                  <input
                    ...
                    checked={answers[currentQ.id] === String.fromCharCode(65 + optionIndex)}
                    onChange={(e) => handleAnswerSelect(currentQ.id, e.target.value)}
                    className="sr-only"
                  />
                  <span className="flex-shrink-0 w-6 h-6 border-2 rounded-full flex items-center justify-center mr-4">
                    {answers[currentQ.id] === String.fromCharCode(65 + optionIndex) && (
