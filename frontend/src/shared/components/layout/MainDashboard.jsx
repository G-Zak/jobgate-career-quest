...
import JobExplorerPage from '../../../features/job-recommendations/components/JobExplorerPage';
import SavedJobsPage from '../../../features/job-recommendations/components/SavedJobsPage';
import ApplicationsPage from '../../../features/job-recommendations/components/ApplicationsPage';
import CareerAdvicePage from '../../../features/career-advice/components/CareerAdvicePage';
      ...
      <div id="dashboard-layout" className="main-layout flex max-w-screen-2xl mx-auto px-12 pt-28 gap-8 items-start">
        ...
        <div id="sidebar" className="sidebar-navigation w-72">
          <div className="sidebar-card w-72 bg-white rounded-xl shadow-sm fixed top-28 h-[calc(100vh-8rem)] overflow-y-auto z-10">
            ...
            <div className="job-offers-section p-6">
              <div className="mb-4">
            ...
            <div className="skills-section p-6">
              <div className="mb-4">
                ...
                <div className="space-y-2">
                  ...
                  <div id="skills-validation" className="skills-validation-section">
                    <button
            ...
            {/* Test History - Separate item at bottom */}
            <div className="test-history-section p-6">
              <button
                onClick={() => setActiveSection('tests-history')}
                className={`sidebar-nav-item w-full flex items-center justify-between px-4 py-3 rounded-lg text-left font-semibold text-sm transition-colors ${activeSection === 'tests-history'
                  ? 'text-blue-500 bg-blue-50 border-l-4 border-blue-500'
                  : 'text-gray-700 hover:bg-blue-50'
                  }`}
              >
