...
class Command(BaseCommand):
 ...
 self.stdout.write(f" Warning: Error creating weights: {e}")
 ...
 self.stdout.write(" Warning: Clustering training skipped (insufficient data)")

 except Exception as e:
 self.stdout.write(f" Warning: Clustering training failed: {str(e)}")
 ...
 self.stdout.write(f"Clustering Model: {'Yes' if cluster_model else 'No'}")
