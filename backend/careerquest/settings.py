...
SECRET_KEY = "django-insecure-@a+p!xz-rq!6(tur$(xp_%u0e3=8q&z12#@5bb7bi3cdbfkusp"
...
INSTALLED_APPS = [
    ...
    "drf_spectacular",
    "corsheaders",
    "auth_api", # Simple authentication API
    "skills",
    "testsengine",
    "recommendation",
]
...
# Custom User Model
# AUTH_USER_MODEL = 'accounts.User' # Temporarily disabled
...
# Import enhanced database configuration
...
CACHES = {
 ...
 'TIMEOUT': 600, # 10 minutes for dashboard data
 },
 'achievements': {
 'BACKEND': 'django_redis.cache.RedisCache',
 ...
 'KEY_PREFIX': 'achievements',
 'TIMEOUT': 1800, # 30 minutes for achievements (rarely change)
 }
}
